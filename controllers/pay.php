...
foreach($_SESSION['cart'] as $id => $quantity){
	...
	$cart_total += ($quantity * $item_info['price']);
}

$new_order_query = "INSERT INTO orders(user_id, transaction_code, purchase_date, status_id, payment_mode_id, total) VALUES ('$user_id', '$transaction_code', '$purchase_date', '$status_id', '$payment_mode_id', '$cart_total')";
...
if($new_order){
	foreach($_SESSION['cart'] as $id => $quantity){
		...
		$order_item_query = "INSERT INTO orders_items(order_id, item_id, quantity, price) VALUES ('$new_order_id', '$id', '$quantity')";
	}
}
